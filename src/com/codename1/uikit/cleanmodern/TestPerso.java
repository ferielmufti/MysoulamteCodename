...
f = new Form("Test personnalité");
        ServiceMatching serviceMatching = new ServiceMatching();
        ArrayList<Question> Questions = serviceMatching.TestPerso();
        serviceMatching.ajouterPersoVide(id);
        ...
        btnajout.addActionListener((e) -> {
            ...
            if (i < 39) {
                ...
                serviceMatching.ajouterPourcentagePerso(id, Questions.get(i).getTrait(), reponse);
