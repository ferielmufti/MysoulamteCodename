 ...
 * @author Fatma
 */
public class StatistiquesPerso {
...
interest=sm.getInterestsPerso(id);
double sum=interest.getPourcent1()+interest.getPourcent2()+interest.getPourcent3()+interest.getPourcent4()+interest.getPourcent5();
        ...
        PieChart chart = new PieChart(buildCategoryDataset("Votre personnalité", values), renderer);

        // Wrap the chart in a Component so we can add it to a form
        ChartComponent c = new ChartComponent(chart);

        // Create a form and show it.
        Form f = new Form("Votre personnalité");
